...
module.exports = __webpack_require__(/*! C:\Users\Panda\Desktop\React\breakout\src\main.js */335);
...
var _Gameover = __webpack_require__(/*! ./states/Gameover */ 353);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function preload() {
      ...
      this.load.image('brick', './assets/images/invader.png');
      this.load.image('brick2', './assets/images/invader2.png');
      this.load.image('brick3', './assets/images/invader3.png');
      this.load.image('brick4', './assets/images/invader4.png');
      this.load.image('brick5', './assets/images/invader5.png');
      this.load.image('brick6', './assets/images/invader6.png');
...
var _Brick3 = __webpack_require__(/*! ../prefabs/Brick2 */ 348);

var _Brick4 = _interopRequireDefault(_Brick3);

var _Brick5 = __webpack_require__(/*! ../prefabs/Brick3 */ 349);

var _Brick6 = _interopRequireDefault(_Brick5);

var _Brick7 = __webpack_require__(/*! ../prefabs/Brick4 */ 350);

var _Brick8 = _interopRequireDefault(_Brick7);

var _Brick9 = __webpack_require__(/*! ../prefabs/Brick5 */ 351);

var _Brick10 = _interopRequireDefault(_Brick9);

var _Brick11 = __webpack_require__(/*! ../prefabs/Brick6 */ 352);

var _Brick12 = _interopRequireDefault(_Brick11);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'preload',
    value: function preload() {
      this.load.image('bullet', './assets/images/enemy-bullet.png');
    }
  }, {
    key: 'create',
    value: function create() {
    ...
    value: function releaseBall() {
      var difficulty = (this.game.global.stage + 3) * 50;
      if (!this.ballOnPaddle) {
        return;
      }
      this.ballOnPaddle = false;
      this.ball.body.velocity.x = Math.floor(Math.random() * 301) - 150;
      this.ball.body.velocity.y = difficulty + Math.floor(Math.random() * 201);
    }
    ...
    value: function setUpText() {
      this.livesText = this.createText(20, 20, 'left', 'Lives: ' + this.game.global.lives);
      this.stageText = this.createText(0, 20, 'center', 'Stage: ' + this.game.global.stage);
      this.scoreText = this.createText(-20, 20, 'right', 'Score: ' + this.game.global.score);
    }
  }, {
    key: 'setUpBricks',
    ...
    key: 'enemyHitsPlayer',
    value: function enemyHitsPlayer(paddle, bullet) {
      bullets.kill();
      --this.game.global.lives;
    ...
    value: function generateBricks(bricksGroup) {
      ...
      for (var y = 0; y < rows; y++) {
        for (var x = 0; x < columns; x++) {
          //randomly adding new invaders
          z = Math.floor(Math.random() * 4);
          switch (z) {
            case 0:
              brick = new _Brick10.default(this.game, x * xOffset, y * yOffset);
            ...
            case 1:
              ...
              brick = new _Brick12.default(this.game, x * xOffset, y * yOffset);
              bricksGroup.add(brick);

              brick = new _Brick4.default(this.game, x * xOffset, y * yOffset);
              bricksGroup.add(brick);

              break;

            case 2:
              brick = new _Brick6.default(this.game, x * xOffset, y * yOffset);
              bricksGroup.add(brick);
              break;

            case 3:
              brick = new _Brick8.default(this.game, x * xOffset, y * yOffset);
              bricksGroup.add(brick);
              break;
          }
        }
      ...
      //change this.. position of bricks
      bricksGroup.position.setTo(this.game.world.centerX - bricksGroupWidth, this.game.world.centerY - 225);
    }
  }, {
    key: 'createText',
    value: function createText(xOffset, yOffset, align, text) {
      return this.game.add.text(xOffset, yOffset, text, {
        //see if i can change font
        font: '20px Roboto',
        fill: '#fff',
        boundsAlignH: align
    ...
    value: function update() {
      ...
      game.physics.arcade.overlap(bullets, this.paddle, this.enemyHitsPlayer, null, this);
    ...
    value: function fire() {
      ...
      if (this.time.now > enemyBulletTime) {
        ...
        if (bullets && livingEnemies.length > 0) {
          var fireSpeed = this.game.global.stage * 40 + 150 + Math.floor(Math.random() * 7) * 25;
          console.log(fireSpeed);
          var random = this.rnd.integerInRange(0, livingEnemies.length - 1);
          var shooter = livingEnemies[random];
          bullet.reset(shooter.body.x + 15, shooter.body.y + 20);
          enemyBulletTime = this.time.now + 1800 - Math.random() * 800;
          this.physics.arcade.moveToObject(bullet, this.paddle, fireSpeed);
        }
      }
    }
  }, {
    ...
    value: function ballHitBrick(ball, brick) {
      ...
      this.game.global.stage += 1;
      this.stageText.text = 'Stage: ' + this.game.global.stage;
...
var Brick2 = function (_Phaser$Sprite) {
    _inherits(Brick2, _Phaser$Sprite);

    function Brick2(game, x, y) {
        _classCallCheck(this, Brick2);

        var _this = _possibleConstructorReturn(this, (Brick2.__proto__ || Object.getPrototypeOf(Brick2)).call(this, game, x, y, 'brick2'));
...
exports.default = Brick2;

/***/ }),
/* 349 */
/*!*******************************!*\
  !*** ./src/prefabs/Brick3.js ***!
  \*******************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var Brick3 = function (_Phaser$Sprite) {
    _inherits(Brick3, _Phaser$Sprite);

    function Brick3(game, x, y) {
        _classCallCheck(this, Brick3);

        var _this = _possibleConstructorReturn(this, (Brick3.__proto__ || Object.getPrototypeOf(Brick3)).call(this, game, x, y, 'brick3'));
...
exports.default = Brick3;

/***/ }),
/* 350 */
/*!*******************************!*\
  !*** ./src/prefabs/Brick4.js ***!
  \*******************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var Brick4 = function (_Phaser$Sprite) {
    _inherits(Brick4, _Phaser$Sprite);

    function Brick4(game, x, y) {
        _classCallCheck(this, Brick4);

        var _this = _possibleConstructorReturn(this, (Brick4.__proto__ || Object.getPrototypeOf(Brick4)).call(this, game, x, y, 'brick4'));
...
exports.default = Brick4;

/***/ }),
/* 351 */
/*!*******************************!*\
  !*** ./src/prefabs/Brick5.js ***!
  \*******************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var Brick5 = function (_Phaser$Sprite) {
    _inherits(Brick5, _Phaser$Sprite);

    function Brick5(game, x, y) {
        _classCallCheck(this, Brick5);

        var _this = _possibleConstructorReturn(this, (Brick5.__proto__ || Object.getPrototypeOf(Brick5)).call(this, game, x, y, 'brick5'));
...
exports.default = Brick5;

/***/ }),
/* 352 */
/*!*******************************!*\
  !*** ./src/prefabs/Brick6.js ***!
  \*******************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var Brick6 = function (_Phaser$Sprite) {
    _inherits(Brick6, _Phaser$Sprite);

    function Brick6(game, x, y) {
        _classCallCheck(this, Brick6);

        var _this = _possibleConstructorReturn(this, (Brick6.__proto__ || Object.getPrototypeOf(Brick6)).call(this, game, x, y, 'brick6'));
...
var _class = function (_Phaser$State) {
    ...
    _createClass(_class, [{
        ...
        value: function create() {
            ...
            starfield = game.add.tileSprite(0, 0, 800, 600, 'background');
            var text = this.add.text(this.game.world.centerX, this.game.height / 2, 'Game Over \nYou reached stage ' + this.game.global.stage + ' \nwith a score of ' + this.game.global.score + '\n\nClick to try again', {
                font: '24px Roboto',
                fill: '#fff',
                align: 'center'
            });
